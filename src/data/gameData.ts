...
for (let ch = 2; ch <= 10; ch++) {
  ...
  const titles = [
    ...
    ['The Sacred Sanctuary', 'The Sacred Sanctuary'],
    ['Trial of Valor', 'Trial of Valor'],
    ['The Demon Vanguard', 'The Demon Vanguard'],
    ['The Storming of Gates', 'The Storming of Gates'],
  ];
...
export const CHARACTERS_LORE: CharacterLore[] = [
  {
    ...
    abilities: [
      ...
      { name: 'Divine Aura', desc: 'Activates invulnerability, HP regeneration, and radiant speed bursts.' },
