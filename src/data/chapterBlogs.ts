...
export const CHAPTER_BLOGS: ChapterBlog[] = [
  {
    ...
    hindiTitle: 'Glory of Ayodhya & Sage Vishwamitra',
    kanda: 'Bala Kanda',
    location: 'Sarayu Riverbanks & Forest Hermitage of Siddhashrama',
    readTime: '3 min read',
    dateTag: 'Treta Yuga • Sacred Chronicle I',
    sacredSloka: {
      sanskrit: 'Ramo vigrahavan dharmah sadhuh satyaparakramah | Raja sarvasya lokasya devanamiva vasavah ||',
  ...
  },
  {
    ...
    hindiTitle: 'Sacrifice, Exile & Entry into Dandakaranya',
    kanda: 'Ayodhya Kanda',
    location: 'Ganga Confluence & Chitrakoot Hermitage',
    readTime: '4 min read',
    dateTag: 'Treta Yuga • Sacred Chronicle II',
    sacredSloka: {
      sanskrit: 'Satyameveshvaro loke satye dharmah sada shritah | Satyamulani sarvani satyannasti param padam ||',
  ...
  },
  {
    ...
    hindiTitle: 'Panchavati Ashram & Defeat of Khara-Dushana',
    kanda: 'Aranya Kanda',
    location: 'Godavari Riverbank & Panchavati Groves',
    readTime: '4 min read',
    dateTag: 'Treta Yuga • Sacred Chronicle III',
    sacredSloka: {
      sanskrit: 'Na hi dharmavihinena sukham shakyamupasitum | Dharmadeva prabhavati dharme sarvam pratishthitam ||',
  ...
  },
  {
    ...
    hindiTitle: 'Golden Deer Illusion & Overcoming Maricha',
    kanda: 'Aranya Kanda',
    location: 'Misty Bamboo Glades of Dandaka',
    readTime: '3 min read',
    dateTag: 'Treta Yuga • Sacred Chronicle IV',
    sacredSloka: {
      sanskrit: 'Yato dharmastato jayah | Yato dharmastatah krishnah yato dharmastato jayah ||',
  ...
  },
  {
    ...
    hindiTitle: 'Abduction of Sita, Valor of Jatayu & Fall of Pride',
    kanda: 'Aranya Kanda',
    location: 'Ashram Clearings & Southern Skies',
    readTime: '5 min read',
    dateTag: 'Treta Yuga • Sacred Chronicle V',
    sacredSloka: {
      sanskrit: 'Na kalamativartante mahavrikshah samahitah | Sarvam hi vihitam daivatkalo hi duratikramah ||',
  ...
  },
  {
    ...
    hindiTitle: 'Kishkindha Alliance, Brotherhood of Sugriva & Slaying of Vali',
    kanda: 'Kishkindha Kanda',
    location: 'Pampa Lake & Rishyamukha Mountain',
    readTime: '4 min read',
    dateTag: 'Treta Yuga • Sacred Chronicle VI',
    sacredSloka: {
      sanskrit: 'Mitrani dhanadhanyani mitrani svajanastatha | Mitravanto hi jivanti mitrani paramo nidhih ||',
  ...
  },
  {
    ...
    hindiTitle: 'The Sacred Ocean Bridge & Boundless Devotion',
    kanda: 'Sundara & Yuddha Kanda',
    location: 'Rameshwaram Coastline & Southern Ocean',
    readTime: '4 min read',
    dateTag: 'Treta Yuga • Sacred Chronicle VII',
    sacredSloka: {
      sanskrit: 'Samudramiva gambhirye dhairyena himavaniva | Vishnuna sadrisho virye somavatpriyadarshanah ||',
    ...
    antagonistProfile: {
      ...
      hindiName: 'Ocean Rakshasa Guards',
  ...
  },
  {
    ...
    hindiTitle: 'Golden Citadel of Lanka & Clash with Titan Kumbhakarna',
    kanda: 'Yuddha Kanda',
    location: 'Northern Fortress Gates of Trikuta Hill, Lanka',
    readTime: '5 min read',
    dateTag: 'Treta Yuga • Sacred Chronicle VIII',
    sacredSloka: {
      sanskrit: 'Na bhayam vindate kinchid yudhyamanah samahitah | Dharmo rakshati rakshitah tasmad dharmam na samtyajet ||',
  ...
  },
  {
    ...
    hindiTitle: 'Sorcery of Meghanada & Fall of Indrajit',
    kanda: 'Yuddha Kanda',
    location: 'Nikumbhila Sacrificial Altar & Lanka Sky',
    readTime: '4 min read',
    dateTag: 'Treta Yuga • Sacred Chronicle IX',
    sacredSloka: {
      sanskrit: 'Satyam vada dharmam cara svadhyayadma pramadah | Satyanna pramaditavyam ||',
  ...
  },
  {
    ...
    hindiTitle: 'Final Great War, Defeat of Ten-Headed Raone & Victory of Dharma',
    kanda: 'Yuddha Kanda',
    location: 'Central Battlefield Arena of Lanka',
    readTime: '6 min read',
    dateTag: 'Treta Yuga • Sacred Chronicle X',
    sacredSloka: {
      sanskrit: 'Dharmatma satyasandhashca ramo dasharathirmahan | Na hi tasyasti sadrisho virye lokeshu kashcana ||',
    ...
    sacredWeapon: 'The Supreme Brahmastra',
  },
];
